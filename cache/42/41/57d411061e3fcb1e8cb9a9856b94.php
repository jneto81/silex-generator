...
/* Address\new.html.twig */
class __TwigTemplate_424157d411061e3fcb1e8cb9a9856b94 extends Twig_Template
{
...
<form action=\"";
        // line 14
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("address_create"), "html", null, true);
        echo "\" method=\"post\" ";
...
<ul class=\"record_actions unstyled container inline\">
    <li>
        ...
        // line 23
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("address"), "html", null, true);
        echo "\">
            Back to the list
        </a>
    </li>
