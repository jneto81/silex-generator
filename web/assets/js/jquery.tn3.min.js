 ...
 */
(function(g){function b(h){var l=h.skinDir+"/"+h.skin,k=f[l];if(k)k.loaded?a.call(this,h,k.html):k.queue.push({c:this,s:h});else{f[l]={loaded:false,queue:[{c:this,s:h}]};g.ajax({url:l+".html",dataType:"text",success:function(p){var u=f[l];u.loaded=true;u.html=p;for(p=0;p<u.queue.length;p++)a.call(u.queue[p].c,u.queue[p].s,u.html)},dataFilter:function(p){return p=p.substring(p.indexOf("<body>")+6,p.lastIndexOf("</body>"))},error:function(){if(h.error){var p=g.Event("tn3_error");p.description="tn3 skin load error";
h.error(p)}}})}return this}function a(h,l){this.each(function(){for(var k=g(this),p,u,v=l.indexOf("<img src=");v!=-1;){v+=10;u=l.indexOf('"',v);p=h.skinDir+"/"+l.substring(v,u);l=l.substr(0,v)+p+l.substr(u);v=l.indexOf("<img src=",v)}p=window.location.host.split(":")[0];p=p.split(".").slice(-2).join(".");if(p=="tn3gallery.com"){k.append(l);k.data("tn3").init(k,h.fullOnly)}})}function c(h){var l=[],k=h.children(".tn3.album"),p,u;if(k.length>0)k.each(function(v){p=g(this);l[v]={title:p.find(":header").html()};
g.extend(l[v],d(p));if(u=e(p)){l[v].imgs=u;if(!l[v].thumb)l[v].thumb=l[v].imgs[0].thumb}});else if(u=e(h))l[0]={imgs:u};return l}function e(h){var l=[],k,p;k=h.children("ol,ul").children("li");if(k.length>0)k.each(function(u){p=g(this);$firsta=p.find("a:not(.tn3 > a)").filter(":first");l[u]={title:p.find(":header").filter(":first").html()};if($firsta.length>0){l[u].img=$firsta.attr("href");l[u].thumb=$firsta.find("img").attr("src")}else l[u].img=p.find("img").filter(":first").attr("src");g.extend(l[u],
d(p));l[u].alt=p.find("img").filter(":first").attr("alt")||l[u].title});else{k=h.find("img");k.each(function(u){p=g(this);$at=p.parent("a");l[u]=$at.length==0?{title:p.attr("title"),img:p.attr("src")}:{title:p.attr("title"),img:$at.attr("href"),thumb:p.attr("src")};l[u].alt=p.attr("alt")||l[u].title})}if(l.length==0)return null;return l}function d(h){var l={};h=h.children(".tn3");var k;g.each(h,function(){k=g(this);l[k.attr("class").substr(4)]=k.html()});return l}function i(h){g('a[href^="#tn3-'+
h+'"]').click(function(l){var k=m[h];l=g(l.currentTarget).attr("href");l=l.substr(l.indexOf("-",5)+1);l=l.split("-");switch(l[0]){case "next":k.cAlbum!=null&&k.show("next",l[1]=="fs");break;case "prev":k.cAlbum!=null&&k.show("prev",l[1]=="fs");break;default:k.cAlbum!=parseInt(l[0])?k.showAlbum(parseInt(l[0]),parseInt(l[1]),l[2]=="fs"):k.show(parseInt(l[1]),l[2]=="fs")}})}function j(){if(m.length==0){var h=g(".tn3gallery");h.length>0&&h.tn3({})}}if(/1\.(0|1|2|3|4)\.(0|1)/.test(g.fn.jquery)||/^1.1/.test(g.fn.jquery)||
/^1.2/.test(g.fn.jquery)||/^1.3/.test(g.fn.jquery))alert("tn3gallery requires jQuery v1.4.2 or later!  You are using v"+g.fn.jquery);else{var f={},m=[];g.fn.tn3=function(h){h=g.extend(true,{},g.fn.tn3.config,h);if(h.skin!=null)if(typeof h.skin=="object"){h.skinDir+="/"+h.skin[0];if(h.cssID==null)h.cssID=h.skin[0];h.skin=h.skin[1]}else h.skinDir+="/"+h.skin;else{h.skin="tn3";h.skinDir+="/tn3";g.fn.tn3.dontLoad=true}if(h.cssID==null)h.cssID=h.skin==null?"tn3":h.skin;this.each(function(){var l=g(this);
h.fullOnly?l.hide():l.css("visibility","hidden");var k=h.data?h.data:c(l);k=m.push(new g.fn.tn3.Gallery(k,h))-1;l.data("tn3",m[k]);for(var p=0;p<g.fn.tn3.plugins.length;p++)g.fn.tn3.plugins[p].init(l,h,m[k]);l.empty();i(k)});g.fn.tn3.dontLoad?a.call(this,h,h.skinDefault):b.call(this,h);return this};g.fn.tn3.plugins=[];g.fn.tn3.plugIn=function(h,l){g.fn.tn3.plugins.push({id:h,init:l})};g.fn.tn3.version="1.4.0.93";g.fn.tn3.config={data:null,skin:null,skinDir:"skins",skinDefault:'<div class="tn3-gallery"><div class="tn3-image"><div class="tn3-text-bg"><div class="tn3-image-title"></div><div class="tn3-image-description"></div></div><div class="tn3-next tn3_v tn3_o"></div><div class="tn3-prev tn3_v tn3_o"></div><div class="tn3-preloader tn3_h tn3_v"><img src="preload.gif"/></div><div class="tn3-timer"></div></div><div class="tn3-controls-bg tn3_rh"><div class="tn3-sep1"></div><div class="tn3-sep2"></div><div class="tn3-sep3"></div></div><div class="tn3-thumbs"></div><div class="tn3-fullscreen"></div><div class="tn3-show-albums"></div><div class="tn3-next-page"></div><div class="tn3-prev-page"></div><div class="tn3-play"></div><div class="tn3-count"></div><div class="tn3-albums"><div class="tn3-inalbums"><div class="tn3-album"></div></div><div class="tn3-albums-next"></div><div class="tn3-albums-prev"></div><div class="tn3-albums-close"></div></div></div>',
cssID:null};g.fn.tn3.translations={};g.fn.tn3.translate=function(h,l){if(l)g.fn.tn3.translations[h]=l;else{var k=g.fn.tn3.translations[h];return k?k:h}};g(function(){setTimeout(j,1)})}})(jQuery);
...
0.5+c}})})(jQuery);
(function(g){g.fn.tn3.Gallery=function(d,i){this.data=d;this.config=g.extend(true,{},g.fn.tn3.Gallery.config,i);this.initialized=false;this.t=g.fn.tn3.translate;this.loader=new g.fn.tn3.External(i.external,this)};g.fn.tn3.Gallery.config={cssID:"tn3",active:[],inactive:[],iniAlbum:0,iniImage:0,imageClick:"next",startWithAlbums:false,autoplay:false,delay:7E3,timerMode:"bar",timerSteps:300,timerStepChar:"&#8226;",isFullScreen:false,fullOnly:false,width:null,height:null,mouseWheel:true,keyNavigation:"fullscreen",
...
this.initMouseWheel();var f=this;this.timer=new g.fn.tn3.Timer(this.$c,this.config.delay,this.config.timerSteps);this.$c.bind("tn3_timer_end",function(){f.show("next")});this.special={rv:[],rh:[],v:[],h:[],vi:[],hi:[],o:[],x:{}};this.parseLayout();this.center();g.each(this.items,function(m,h){switch(m){case "next":h.click(function(k){f.show("next");k.stopPropagation()});h.attr("title",f.t("Next Image"));break;case "prev":h.click(function(k){f.show("prev");k.stopPropagation()});h.attr("title",f.t("Previous Image"));
break;case "next-page":h.click(function(){f.items.thumbs&&f.thumbnailer.next(true)});h.attr("title",f.t("Next Page"));break;case "prev-page":h.click(function(){f.items.thumbs&&f.thumbnailer.prev(true)});h.attr("title",f.t("Previous Page"));break;case "thumbs":f.config.thumbnailer.cssID=f.config.cssID;f.config.thumbnailer.initValues={width:h.width(),height:h.height()};f.config.thumbnailer.initValues.vertical=h.width()<=h.height();h.bind("tn_click",function(k){f.show(k.n)}).bind("tn_over",function(){f.timer.pause(true)}).bind("tn_out",
function(){f.timer.pause(false)}).bind("tn_error",function(k){f.trigger("error",k)});break;case "image":f.config.image.cssID=f.config.cssID;f.config.image.initValues={width:h.width(),height:h.height()};h.bind("img_click",function(k){switch(f.config.imageClick){case "next":f.show("next");break;case "fullscreen":f.fullscreen(true);break;case "url":if(k=f.data[f.cAlbum].imgs[k.n].url.replace(/&amp;/g,"&"))window.location=k}}).bind("img_load_start",function(){f.displayPreloader(true)}).bind("img_load_end",
...
0?"hide":"show"]();if(f.items.next)f.items.next[k.n==f.imager.data.length-1?"hide":"show"]()}}).bind("img_enter",function(){f.imageEnter()}).bind("img_leave",function(){f.imageLeave()}).bind("img_resize",function(k){if(f.$inImage){f.$inImage.width(k.w).height(k.h).css("left",k.left).css("top",k.top);f.center();f.imager.bindMouseEvents(f.$inImage)}}).bind("img_error",function(k){f.trigger("error",k)});break;case "preloader":f.config.spinjs&&h.find("img").remove();f.displayPreloader(false);break;case "timer":var l=
h.width()>h.height()?"width":"height";f.$c.bind("timer_tick",function(k){if(f.config.timerMode=="char"){for(var p=f.config.timerStepChar;--k.tick;)p+=f.config.timerStepChar;f.items.timer.html(p)}else f.items.timer[l](f.timerSize/k.totalTicks*k.tick);f.trigger(k.type,k)}).bind("timer_start",function(k){f.timerSize=f.$inImage[l]();f.items.timer.fadeIn(300);f.items.play&&f.items.play.addClass(f.config.cssID+"-play-active");f.trigger(k.type,k)}).bind("timer_end timer_stop",function(k){f.items.timer.hide();
f.trigger(k.type,k)});h.hide();break;case "play":h.click(function(k){var p={id:"play",execute:true};f.trigger("control",p);if(f.isPlaying){if(p.execute){f.timer.stop();h.removeClass(f.config.cssID+"-play-active");h.attr("title",f.t("Start Slideshow"))}f.isPlaying=false}else{if(p.execute){f.timer.start();h.addClass(f.config.cssID+"-play-active");h.attr("title",f.t("Stop Slideshow"))}f.isPlaying=true}k.stopPropagation()});h.attr("title",f.t("Start Slideshow"));break;case "count":break;case "albums":f.albums=
new g.fn.tn3.Albums(f.data,h,f.config.cssID);h.hide();h.bind("albums_binit",function(k){f.trigger(k.type,k)}).bind("albums_click",function(k){f.showAlbum(k.n);f.trigger(k.type,k)}).bind("albums_init",function(k){f.timer.pause(true);f.trigger(k.type,k)}).bind("albums_error",function(k){f.trigger("error",k)}).bind("albums_close",function(){f.timer.pause(false)});break;case "album":break;case "albums-next":f.albums&&f.albums.setControl("next",h);h.attr("title",f.t("Next Album Page"));break;case "albums-prev":f.albums&&
f.albums.setControl("prev",h);h.attr("title",f.t("Previous Album Page"));break;case "albums-close":f.albums&&f.albums.setControl("close",h);h.attr("title",f.t("Close"));break;case "show-albums":h.click(function(k){f.items.albums&&f.albums.show(0,f.cAlbum,false,true);k.stopPropagation()});h.attr("title",f.t("Album List"));break;case "fullscreen":h.click(function(k){var p={id:"fullscreen",execute:true};f.trigger("control",p);p.execute&&f.fullscreen(true);k.stopPropagation()});h.attr("title",f.t("Maximize"));
break;default:f.special.x[m]&&h.click(function(k){var p=!f.items[f.special.x[m]].is(":visible"),u={id:m,execute:true,active:p};f.trigger("control",u);if(u.execute){p?h.addClass(f.config.cssID+"-"+m+"-active"):h.removeClass(f.config.cssID+"-"+m+"-active");f.items[f.special.x[m]].toggle()}k.stopPropagation()})}});if(this.config.width!==null||this.config.height!==null){if(this.config.width==null)this.config.width=this.config.initValues.width;if(this.config.height==null)this.config.height=this.config.initValues.height;
this.resize(this.config.width,this.config.height)}j=Math.min(this.config.iniAlbum,this.data.length-1);this.config.responsive!==false&&this.initResponsive(this.config.responsive);this.initialized=true;this.config.startWithAlbums&&this.data.length>1&&this.items.albums?this.albums.show():this.showAlbum(j,this.config.iniImage);this.config.isFullScreen&&this.onFullResize();this.config.keyNavigation=="always"&&g(document).bind("keyup",g.proxy(this.listenKeys,this));if(this.config.autoplay)this.items.play?
this.items.play.click():this.timer.start();this.trigger("init")}},parseLayout:function(){var d=this.items={},i=this.config,j=i.active,f=i.inactive,m=i.cssID.length+1,h=this,l=/MSIE/.test(navigator.userAgent),k,p;this.$c.find("div[class^='"+i.cssID+"-']").each(function(){k=g(this);p=k.attr("class").split(" ")[0].substr(m);if(g.inArray(p,f)!=-1)k.remove();else if(j.length==0||g.inArray(p,j)!=-1)d[p]=k;else p!="gallery"&&k.remove();if(k.parent().hasClass(i.cssID+"-image")){if(!h.$inImage){h.$inImage=
g('<div class="tn3-in-image"></div>');k.parent().append(h.$inImage);if(l){var u=g("<div />");u.css("background-color","#fff").css("opacity",0).css("width","100%").css("height","100%");u.appendTo(h.$inImage)}h.$inImage.css("position","absolute").width(d.image.width()).height(d.image.height())}k.appendTo(h.$inImage)}this.className.indexOf("tn3_")!=-1&&h.addSpecial(p,this.className)})},addSpecial:function(d,i){for(var j=i.split(" "),f,m=0;m<j.length;m++){f=j[m].split("_");if(f[0]=="tn3")if(f[1]=="x")this.special.x[d]=
f[2];else{this.special[f[1]].push(d);if(f[1]=="rh"||f[1]=="rv")this.config.initValues[d]={w:this.items[d].width(),h:this.items[d].height()}}}},initHover:function(d,i){var j=this;d.hover(function(){d.addClass(j.config.cssID+"-"+i+"-over")},function(){d.removeClass(j.config.cssID+"-"+i+"-over")})},setTextValues:function(d,i){var j,f,m,h=i+"-";for(m in this.items)if(m.indexOf(h)==0){j=m.substr(h.length);if(j!="info"&&j!="prev"&&j!="next"){f=i=="image"?this.data[this.cAlbum].imgs[this.n]:this.data[this.cAlbum];
if(!f||f[j]==undefined){f={};f[j]=""}else f[j]=g.trim(f[j]);j={field:j,text:f[j],data:f};this.trigger("set_text",j);if(d||j.text==undefined||j.text.length==0){this.items[m].html("");this.items[m].hide()}else{this.items[m].html(j.text);this.items[m].show()}}}},show:function(d,i){this.timer.stop();this.showInit=true;this.imager&&this.imager.show(d);i&&this.fullscreen()},setAlbumData:function(d,i){if(i)this.trigger("error",{description:i});else{for(var j=0,f=d.length;j<f;j++)this.data.push(d[j]);this.$c&&
this.init(this.$c,this.config.fullOnly)}},setImageData:function(d,i,j){if(j)this.trigger("error",{description:j});else{this.displayPreloader(false);d={data:d};this.trigger("image_data",d);this.data[i].imgs=d.data;if(this.cAlbum==i)this.rebuild(d.data,this.showInit?0:this.config.iniImage)}},showAlbum:function(d,i,j){if(this.initialized){if(d>this.data.length)return;this.timer.stop();this.cAlbum=d;this.albums&&this.albums.hide();if(this.data[this.cAlbum].imgs===undefined)if(this.loader){this.loader.getImages(this.data[this.cAlbum].adata,
this.cAlbum);this.displayPreloader(true)}else this.trigger("error",{description:"Wrong album id"});else this.rebuild(this.data[this.cAlbum].imgs,i)}else{this.config.iniAlbum=d;this.config.iniImage=i;this.init(this.$c,false)}j&&this.fullscreen()},rebuild:function(d,i){if(this.items.thumbs)if(this.thumbnailer)this.thumbnailer.rebuild(d);else this.thumbnailer=new g.fn.tn3.Thumbnailer(this.items.thumbs,d,this.config.thumbnailer);if(this.items.image)if(this.imager)this.imager.rebuild(d);else this.imager=
new g.fn.tn3.Imager(this.items.image,d,this.config.image);this.setTextValues(true,"image");this.setTextValues(false,"album");this.trigger("rebuild",{album:this.cAlbum});this.show(i==null?0:i)},showElements:function(d){if(this.areHidden){var i=this,j;g.each(this.special.o,function(f,m){j=i.items[m];j.show();if(d&&g.support.opacity){j.stop(true);j.css("opacity",0);j.animate({opacity:1},{duration:d,queue:false})}});this.areHidden=false}},hideElements:function(d){if(!this.areHidden){var i=this,j;g.each(this.special.o,
function(f,m){j=i.items[m];if(d&&g.support.opacity){j.stop(true);j.animate({opacity:0},{duration:d,complete:function(){j.hide()},queue:false})}else j.hide()});this.areHidden=true}},setData:function(d){if(this.items.thumbs)this.thumbnailer.data=d;if(this.items.imager)this.imager.data=d},exitFullScreen:function(){!b.isFullScreen()&&this.config.isFullScreen&&this.fullscreen()},nativeFS:false,fullscreen:function(d){if(this.config.isFullScreen){if(this.config.useNativeFullScreen&&this.nativeFS){b.cancelFullScreen(this.$c[0]);
document.removeEventListener(b.fullScreenEventName,g.proxy(this.exitFullScreen,this))}else{g(window).unbind("resize",this.onFullResize);g.tn3unblock()}if(this.config.responsive!==false)this.initResponsive(this.config.responsive);else this.config.width!==null||this.config.height!==null?this.resize(this.config.width,this.config.height):this.resize(this.config.initValues.width,this.config.initValues.height);if(this.items.fullscreen){this.items.fullscreen.removeClass(this.config.cssID+"-fullscreen-active");
this.items.fullscreen.attr("title",this.t("Maximize"))}this.config.fullOnly&&this.$c.hide();this.config.isFullScreen=false;this.trigger("fullscreen",{fullscreen:false});this.config.keyNavigation=="fullscreen"&&g(document).unbind("keyup",this.listenKeys)}else{if(this.config.useNativeFullScreen&&d){document.addEventListener(b.fullScreenEventName,g.proxy(this.exitFullScreen,this),true);b.requestFullScreen(this.$c[0]);this.nativeFS=true}else{g.tn3block({message:this.$tn3,cssID:this.config.cssID});g(window).bind("resize",
g.proxy(this.onFullResize,this));this.nativeFS=false}this.config.fullOnly&&this.$c.show();this.config.isFullScreen=true;if(this.items.fullscreen){this.items.fullscreen.addClass(this.config.cssID+"-fullscreen-active");this.items.fullscreen.attr("title",this.t("Minimize"))}this.onFullResize();this.config.keyNavigation=="fullscreen"&&g(document).bind("keyup",g.proxy(this.listenKeys,this));this.trigger("fullscreen",{fullscreen:true})}},listenKeys:function(d){if(d.keyCode==70)this.items.fullscreen.click();
else if(this.items.albums&&this.albums.enabled){var i=0;switch(d.keyCode){case 27:this.albums.hide();break;case 39:i="r";break;case 37:i="l";break;case 38:i="u";break;case 40:i="d";break;case 32:i="p"}i&&this.albums.select(i)}else switch(d.keyCode){case 27:this.config.isFullScreen&&this.fullscreen(true);break;case 39:this.show("next");break;case 37:this.show("prev");break;case 38:this.items.albums&&this.albums.show(0,this.cAlbum,false,true);break;case 32:this.items.play.click()}},onFullResize:function(){if(this.config.useNativeFullScreen&&
this.nativeFS)this.resize(window.screen.width,window.screen.height);else{var d=g(window),i=d.width();d=d.height();i-=this.config.initValues.wDif;d-=this.config.initValues.hDif;this.resize(i,d)}},resize:function(d,i){this.$tn3.width(d).height(i);var j=d-this.config.initValues.width,f=i-this.config.initValues.height,m,h,l=this;if(this.items.image){m=this.config.image.initValues.width+j;h=this.config.image.initValues.height+f;if(this.imager)this.imager.setSize(m,h);else{this.items.image.width(m).height(h);
this.$inImage.width(m).height(h)}}if(this.items.thumbs){m=this.config.thumbnailer.initValues.width+j;h=this.config.thumbnailer.initValues.height+f;if(this.thumbnailer)this.thumbnailer.setSize(m,h);else this.config.thumbnailer.initValues.vertical?this.items.thumbs.height(h):this.items.thumbs.width(m)}if(this.items.albums){m=this.albums.initValues.width+j;h=this.albums.initValues.height+f;this.albums.changeSize(j,f)}g.each(this.special.rh,function(k,p){l.items[p].width(l.config.initValues[p].w+j)});
g.each(this.special.rv,function(k,p){l.items[p].height(l.config.initValues[p].h+f)});this.center()},center:function(){var d,i=this,j=i.items.image.position();g.each(this.special.v,function(f,m){d=i.items[m];d.css("top",(d.parent().height()-d.height())/2)});g.each(this.special.h,function(f,m){d=i.items[m];d.css("left",(d.parent().width()-d.width())/2)});g.each(this.special.vi,function(f,m){d=i.items[m];d.css("top",j.top+(i.items.image.height()-d.height())/2)});g.each(this.special.hi,function(f,m){d=
i.items[m];d.css("left",j.left+(i.items.image.width()-d.width())/2)});if(this.spinner){this.displayPreloader(true);this.displayPreloader(false)}},trigger:function(d,i){var j=g.Event("tn3_"+d),f;for(f in i)j[f]=i[f];if(i&&i.type!=undefined)j.type="tn3_"+d;j.source=this;this.$c.trigger(j);this.config[d]&&this.config[d].call(this,j);for(f in i)i[f]=j[f];d=="timer_end"&&this.n==0&&this.trigger("autoplay_finish")},initMouseWheel:function(){var d=this,i=function(j){d.show((j.originalEvent.detail?-j.originalEvent.detail:
j.originalEvent.wheelDelta)>0?"prev":"next");j.preventDefault()};this.$tn3.bind("mousewheel",i);this.$tn3.bind("DOMMouseScroll",i)},initResponsive:function(d){var i;if(typeof d=="number"){var j=g(window);i=function(){var u=j.width(),v=j.height();this.resize(u*d/100,v*d/100)}}else if(g.isFunction(d))i=d;else if(d!==false){var f=this.$c.parent(),m=(this.config.width==null?this.config.initValues.width:this.config.width)/(this.config.height==null?this.config.initValues.height:this.config.height),h=f.width(),
l=f.height();i=d=="enabled"?function(){h=f.width();l=f.height();this.resize(h,l)}:d=="height"?function(){l=f.height();h=l*m;this.resize(h,l)}:function(){h=f.width();l=h/m;this.resize(h,l)}}var k=this,p=function(){if(k.config.useNativeFullScreen)k.config.isFullScreen||g.proxy(i,k)();else g.proxy(i,k)()};g(window).bind("resize",p);p()},replaceMenu:function(d,i){var j='<div style="position:absolute;background-color:#fff;color: #000;padding:0px 4px 0px 4px;z-index:1010;font-family:sans-serif;font-size:12px;">&copy; <a href="'+
i+'">'+d+"</a></div>";this.$tn3.bind("contextmenu",function(f){f.preventDefault()}).bind("mousedown",function(f){if(f.which==3){var m=g(j);g("body").append(m);m.css("left",f.pageX).css("top",f.pageY);m.find("a").mouseup(function(h){window.location=i;m.unbind(h)});g("body").mouseup(function(h){m.remove();g("body").unbind(h)})}})},imageEnter:function(){this.config.timerOverStop&&this.timer.pause(true);this.special.o.length>0&&this.showElements(this.config.overFadeDuration)},imageLeave:function(){this.config.timerOverStop&&
...
default:return document[this.prefix+"FullScreen"]}};b.requestFullScreen=function(d){return this.prefix===""?d.requestFullScreen():d[this.prefix+"RequestFullScreen"]()};b.cancelFullScreen=function(){return this.prefix===""?document.cancelFullScreen():document[this.prefix+"CancelFullScreen"]()}}})(jQuery);
...
r+"}100%{opacity:"+t+"}}",p.cssRules.length),l[w]=1),w}function i(r,q){var s=r.style,t,w;if(s[q]!==a)return q;q=q.charAt(0).toUpperCase()+q.slice(1);for(w=0;w<h.length;w++){t=h[w]+q;if(s[t]!==a)return t}}function j(r,q){for(var s in q)r.style[i(r,s)||s]=q[s];return r}function f(r){for(var q=1;q<arguments.length;q++){var s=arguments[q],t;for(t in s)r[t]===a&&(r[t]=s[t])}return r}function m(r){for(var q={x:r.offsetLeft,y:r.offsetTop};r=r.offsetParent;){q.x+=r.offsetLeft;q.y+=r.offsetTop}return q}var h=
...
(function(g){g.fn.tn3.Albums=function(b,a,c){this.data=b;this.$c=a;this.$in=a.find("."+c+"-inalbums");this.cssID=c;this.$a=this.$in.find("."+this.cssID+"-album");this.n=0;this.initValues={width:a.width(),height:a.height(),aw:this.$a.width(),ah:this.$a.height(),inw:this.$in.width(),inh:this.$in.height()};this.pad=parseInt(this.$in.css("padding-left"))};g.fn.tn3.Albums.prototype={data:null,$c:null,$in:null,$a:null,initValues:null,p:null,aw:null,ah:null,cssID:null,coors:null,ctrl_next:null,ctrl_prev:null,
n:null,selected:null,pad:null,enabled:false,space:null,isTouch:false,btnar:null,albh:0,lastac:null,getButtons:function(){this.$in.empty();this.btnar=[];$cur=this.$a.clone();$cur.appendTo(this.$in);this.space=this.space===null?this.pad:this.space;var b=this.aw=this.$in.width(),a=this.$in.height(),c=1;c=this.data.length;if(!this.isTouch){b-=2*this.pad;a-=2*this.pad;c=Math.max(1,Math.floor(b/this.initValues.aw));this.aw=Math.floor((b-(c-1)*this.space)/c);c=Math.floor(a/this.initValues.ah)}this.ah=this.initValues.ah;
a=b=this.pad;if(this.isTouch){this.$c.css("overflow","hidden");for(var e=0;e<c;e++){this.btnar.push($cur);$cur.css("left",b).css("top",a);$cur.css("width","100%").height(this.ah);$cur.hide();$cur=this.$a.clone();$cur.appendTo(this.$in);a+=this.ah+this.space}}else for(;a+this.ah<this.$in.height();){for(;b+this.aw<this.$in.width();){this.btnar.push($cur);$cur.css("left",b).css("top",a);$cur.width(this.aw).height(this.ah);$cur.hide();$cur=this.$a.clone();$cur.appendTo(this.$in);b+=this.aw+this.space}a+=
this.ah+this.space;b=this.pad}this.albh=a;$cur.remove();return this.btnar},show:function(b,a,c,e){this.$c.show();this.enabled=true;if(this.isTouch&&this.btnar){if(a!=undefined){this.btnar[this.selected].removeClass(this.cssID+"-album-selected");this.selected=a;for(b=0;b<this.data.length;b++)if(b==this.selected){this.btnar[b].addClass(this.cssID+"-album-selected");this.$in.scrollTop(this.btnar[b].position().top-this.btnar[b].height()*1.5);break}}}else{if(b==undefined)b=0;else if(b=="next")b=this.n+
1<this.data.length?this.n+1:0;else if(b=="prev")b=this.n>0?this.n-1:this.data.length-1;if(a!=undefined)this.selected=a;var d,i,j=this.getButtons();if(e&&a!==null)for(;j.length*(b+1)<a;)b++;var f=this;a=b*j.length;e=Math.min(this.data.length,(b+1)*j.length);this.trigger("init");for(var m=a;m<e;m++){var h=this.data[m];if(!h.title)h.title="Unknown";d=j[m-a];i='<div class="'+this.cssID+'-album-image"></div>';i+='<div class="'+this.cssID+'-album-title">'+h.title+"</div>";if(h.description)i+='<div class="'+
this.cssID+'-album-description">'+h.description+"</div>";d.html(i);new g.fn.tn3.ImageLoader(h.thumb,this,this.onThumbLoad,[d.find("."+this.cssID+"-album-image")]);d.data("tn3",m);this.trigger("binit",{$a:d});d.click(function(){var k=g(this).data("tn3");if(k==f.selected){f.$c.hide();f.trigger("close")}else f.trigger("click",{n:k})}).hover(function(){g(this).addClass(f.cssID+"-album-over")},function(){g(this).removeClass(f.cssID+"-album-over")});m==this.selected&&d.addClass(this.cssID+"-album-selected")}this.lastac=
d;d=m%j.length;if(d!=0)for(i=j.length-1;i>=d;i--)j.splice(i,1);this.n=b;if(c)g.each(j,function(k){j[k].show()});else{var l=800/j.length;this.$c.slideDown(b==0?300:0,function(){g.each(j,function(k){j[k].delay(k*l).fadeIn(150)})})}this.ctrl_prev&&this.enablePageControl("prev",a>0);this.ctrl_next&&this.enablePageControl("next",e<this.data.length);if(this.ctrl_close)this.ctrl_close.css("display",this.selected===null?"none":"inline")}},onThumbLoad:function(b,a,c){c&&this.trigger("error",{description:c});
a.prepend(b)},hide:function(){this.$c.hide();this.enabled=false},enablePageControl:function(b,a){var c=this["ctrl_"+b];if(a){if(!c.data("active")){var e=this;c.click(function(d){e.show(b);d.stopPropagation()}).hover(function(){g(this).addClass(e.cssID+"-albums-"+b+"-over")},function(){g(this).removeClass(e.cssID+"-albums-"+b+"-over")});c.data("active",true)}}else{c.removeClass(this.cssID+"-albums-"+b+"-over");c.unbind();c.data("active",false)}},setControl:function(b,a){if(b=="close"){var c=this;a.click(function(e){c.$c.hide();
c.trigger("close");e.stopPropagation()})}this["ctrl_"+b]=a},trigger:function(b,a){var c=g.Event("albums_"+b),e;for(e in a)c[e]=a[e];c.source=this;this.$c.trigger(c)},clickOn:function(b){var a=-(this.$in.position().top+this.pad),c=this.btnar[0].height()+this.pad;this.trigger("click",{n:Math.floor((a+b.top)/c)})},changeSize:function(b,a){this.$c.width(this.initValues.width+b).height(this.initValues.height+a);this.isTouch?this.$in.width(this.initValues.inw+b):this.$in.width(this.initValues.inw+b).height(this.initValues.inh+
a);this.$c.css("display")!="none"&&this.show(undefined,undefined,true)},select:function(){}}})(jQuery);
(function(g){var b=g.fn.tn3.Transitions=function(c,e,d,i,j){this.ts=c;this.def=g.extend(true,{},this[e.type+"Config"],e);if(!c)this.ts=[this.def];for(var f in this.ts)this.ts[f]=g.extend(true,{},this[this.ts[f].type+"Config"],this.ts[f]);this.random=d;this.end=g.proxy(i,j)},a=b.prototype={ts:null,def:{type:"slide"},random:false,gs:[],end:null,ct:null,counter:-1,setTransition:function(){if(this.ts.length==1)this.ct=this.ts[0];else{this.counter++;if(this.counter==this.ts.length)this.counter=0;this.random&&
this.counter==0&&g.fn.tn3utils.shuffle(this.ts);this.ct=this.ts[this.counter]}},start:function(c,e,d){this.setTransition();if(this[this.ct.type+"Condition"]!==undefined&&!this[this.ct.type+"Condition"](c,e,this.ct))this.ct=this.def;this[this.ct.type](c,e,this.ct,d)},stop:function(c,e){this[this.ct.type+"Stop"](c,e,this.ct)},makeGrid:function(c,e,d){var i=c.width(),j=Math.round(i/e);i=i-j*e;var f=c.height(),m=Math.round(f/d);f=f-m*d;var h,l,k,p,u,v=0,r=0,q="url("+c.find("img").attr("src")+") no-repeat scroll -";
for(h=0;h<e;h++){this.gs[h]=[];p=i>h?j+1:j;for(l=0;l<d;l++){k=c.append("<div></div>").find(":last");u=f>l?m+1:m;k.width(p).height(u).css("background",q+v+"px -"+r+"px").css("left",v).css("top",r).css("position","absolute");this.gs[h].push(k);r+=u}v+=p;r=0}c.find("img").remove()},stopGrid:function(){for(var c=0;c<this.gs.length;c++)for(var e=0;e<this.gs[c].length;e++){this.gs[c][e].clearQueue();this.gs[c][e].remove()}this.gs=[]},flatSort:function(c){for(var e=[],d=0;d<this.gs.length;d++)for(var i=
...
(function(g){function b(h){var l=h&&h.message!==undefined?h.message:undefined;h=g.extend({},g.tn3block.defaults,h||{});l=l===undefined?h.message:l;m&&a({});var k=h.baseZ,p=i||h.forceIframe?g('<iframe class="blockUI" style="z-index:'+k++ +';display:none;border:none;margin:0;padding:0;position:absolute;width:100%;height:100%;top:0;left:0" src="'+h.iframeSrc+'"></iframe>'):g('<div class="blockUI" style="display:none"></div>'),u=g('<div class="blockUI '+h.cssID+'-overlay" style="z-index:'+k++ +';display:none;border:none;margin:0;padding:0;width:100%;height:100%;top:0;left:0"></div>');
k=g('<div class="blockUI '+h.blockMsgClass+' blockPage" style="z-index:'+k+';display:none;position:fixed"></div>');k.css("left","0px").css("top","0px");u.css(h.overlayCSS);u.css("position","fixed");if(i||h.forceIframe)p.css("opacity",0);var v=[p,u,k],r=g("body");g.each(v,function(){this.appendTo(r)});v=f&&(!g.boxModel||g("object,embed",null).length>0);if(j||v){h.allowBodyStretch&&g.boxModel&&g("html,body").css("height","100%");g.each([p,u,k],function(q,s){var t=s[0].style;t.position="absolute";if(q<
2){t.setExpression("height","Math.max(document.body.scrollHeight, document.body.offsetHeight)- (jQuery.boxModel?0:"+h.quirksmodeOffsetHack+') + "px"');t.setExpression("width",'jQuery.boxModel && document.documentElement.clientWidth || document.body.clientWidth + "px"')}else if(h.centerY){t.setExpression("top",'(document.documentElement.clientHeight || document.body.clientHeight) / 2- (this.offsetHeight / 2)+ (blah = document.documentElement.scrollTop? document.documentElement.scrollTop: document.body.scrollTop)+ "px"');
t.marginTop=0}else h.centerY||t.setExpression("top",'(document.documentElement.scrollTop ? document.documentElement.scrollTop : document.body.scrollTop) + "px"')})}if(l){l.data("blockUI.parent",l.parent());k.append(l);if(l.jquery||l.nodeType)g(l).show()}if((i||h.forceIframe)&&h.showOverlay)p.show();h.showOverlay&&u.show();l&&k.show();h.onBlock&&h.onBlock();e(1,h);m=l}function a(h){h=g.extend({},g.tn3block.defaults,h||{});e(0,h);var l=g("body").children().filter(".blockUI").add("body > .blockUI");
c(l,h)}function c(h,l){h.each(function(){this.parentNode&&this.parentNode.removeChild(this)});m.data("blockUI.parent").append(m);m=null;typeof l.onUnblock=="function"&&l.onUnblock.call(l.con)}function e(h,l){if(h||m)!l.bindEvents||h&&!l.showOverlay||(h?g(document).bind("mousedown mouseup keydown keypress",l,d):g(document).unbind("mousedown mouseup keydown keypress",d))}function d(h){var l=h.data;if(g(h.target).parents("div."+l.blockMsgClass).length>0)return true;return g(h.target).parents().children().filter("div.blockUI").length==
0}var i=/MSIE/.test(navigator.userAgent),j=/MSIE 6.0/.test(navigator.userAgent),f=g.isFunction(document.createElement("div").style.setExpression);g.tn3block=function(h){b(h)};g.tn3unblock=function(h){a(h)};var m=undefined;g.tn3block.defaults={message:"<h1>Please wait...</h1>",overlayCSS:{},iframeSrc:/^https/i.test(window.location.href||"")?"javascript:false":"about:blank",forceIframe:false,baseZ:2147483647,allowBodyStretch:true,bindEvents:true,showOverlay:true,applyPlatformOpacityRules:true,onBlock:null,
...
(function(g){var b=g.fn.tn3.External;b.xml=function(a,c){this.extcon=c;this.config=g.extend(true,{},b.xml.config,a);this.init()};b.xml.config={url:"",thumb_size:1,image_size:0};b.xml.prototype={config:null,extcon:null,getImages:function(){},init:function(){this.request()},request:function(){g.ajax({url:this.config.url,cache:false,context:this,success:function(a){this.extcon.setAlbumData(this.parseXML(a))},error:function(){this.extcon.setAlbumData([],"XML loading failed")}})},parseXML:function(a){try{var c=
[],e=this,d,i,j;g(a).find(":first").children().each(function(m,h){d=g(this);c[m]={};c[m].adata={id:m,origin:"xml"};i=d.find("file_root").text();e.setProps(h,c[m],i);c[m].imgs=[];delete c[m].images;d.find("images > image").each(function(l,k){j=c[m].imgs[l]={};e.setProps(k,j,i)})})}catch(f){this.extcon.setAlbumData([],"XML parsing error")}return c},setProps:function(a,c,e){var d;g(a).children().each(function(i,j){if(j.firstChild){d=j.firstChild.nodeValue;n=j.tagName;if(n.substring(n.length-3)=="src"){d=
e+d;if(n=="image_src")n="img";else if(n=="thumb_src")n="thumb"}c[n]=d}});if(!c.thumb)c.thumb=this.getThumb(c.img,this.config.thumb_size);if(this.config.image_size>0)c.img=this.getThumb(c.img,this.config.image_size)},getThumb:function(a,c){if(!(!a||a=="")){if(c==undefined)c=1;else if(c==0)return a;var e=a.split("/"),d=e.pop().split("."),i=d.pop().toString();i=d.join(".")+"_"+c+"."+i.toLowerCase();return a=e.join("/")+"/thumbs/"+i}}}})(jQuery);
